...
int main() {
	print_value(make_string("Phase 12 Self-Hosted Lexer Test"));
	print_value(make_string("================================"));
	print_value(make_string("Compiler Infrastructure:"));
	print_value(make_string("- compiler/lexer.kar created"));
	print_value(make_string("- Character classification: isLetter, isDigit, isWhitespace"));
	print_value(make_string("- Keyword lookup: lookupKeyword for 20+ keywords"));
	print_value(make_string("- Token creation: createToken function"));
	print_value(make_string("- Token structure: array-based [type, literal]"));
	print_value(make_string("================================"));
	print_value(make_string("Sample Karkain Source:"));
	print_value(make_string("func main() { var x int = 42 }"));
	print_value(make_string("================================"));
	print_value(make_string("Expected Token Types:"));
	print_value(make_string("FUNC, IDENT, LPAREN, RPAREN, LBRACE"));
	print_value(make_string("VAR, IDENT, IDENT, ASSIGN, INT, RBRACE, EOF"));
	print_value(make_string("================================"));
	print_value(make_string("Lexer Infrastructure Complete"));
	print_value(make_string("Stage 1: Foundation functions ready"));
	print_value(make_string("Stage 2: Full tokenization pending"));
	print_value(make_string("================================"));
	print_value(make_string("Phase 12 Stage 1 complete!"));
	return 0;
}
