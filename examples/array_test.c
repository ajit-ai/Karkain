...
int main() {
	...
	Value* content = readFile;
	Value* list = make_int(0);
	Value* updated_list = appendArray;
	print_value(make_string("Array elements:"));
	printf("%f\n", updated_list[(0 * updated_list_cols + 0)]);
	printf("%f\n", updated_list[(0 * updated_list_cols + 1)]);
	printf("%f\n", updated_list[(0 * updated_list_cols + 2)]);
	printf("%f\n", updated_list[(0 * updated_list_cols + 3)]);
