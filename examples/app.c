...
int main() {
	quantum_init();
	print_value(make_string("--- Karkain Arithmetic Test ---"));
	print_value(binary_op(make_int(100), "-", make_int(45)));
	print_value(binary_op(make_int(12), "*", make_int(12)));
	print_value(binary_op(make_int(50), "/", make_int(2)));
	return 0;
}
