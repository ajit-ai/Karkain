...
var errorRegistry = []explanation{
	...
	{"K145", "Native x86-64 backend: the program uses a construct outside the straight-line v1 surface (control flow, floats, maps, >6 params, string returns/arguments).", "Stay within ints, strings, calls, let/print/return; branches, loops and Value-model types are future slices."},
